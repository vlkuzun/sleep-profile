...
plot_average_power_spectra(['/ceph/harris/somnotate/to_score_set/pickle_eeg_signal/eeg_data_sub-007_ses-01_recording-01.pkl', 
                           ...
                           output_file="/ceph/harris/volkan/sleep_profile/plots/frequency_power/frequency_logpower_all_sub_EEG1.png")